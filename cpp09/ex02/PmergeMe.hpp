...
/*   Updated: 2026/06/06 11:18:11 by kkoujan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    void parseInputVector(std::string &str);
    void parseInputDeque(std::string &str); 
    ...
    void print_message(std::string &str, double deque_time, double vector_time);
};
